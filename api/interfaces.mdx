...
for (TypeMap.Entry<String, String, String> entry : result.getEntryList()) {
    System.out.printf("Key: %s, Type: %s, Value: %s%n",
        ...
        entry.getValue1(), // e.g. "String"
        entry.getValue2()  // e.g. "localhost"
    );
}
```
